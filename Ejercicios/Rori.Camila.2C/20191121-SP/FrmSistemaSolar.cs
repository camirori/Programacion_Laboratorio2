    ...
    public partial class FrmSistemaSolar : Form
    {
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            if(this.animaciones.Count == 0)
            {
                ...
                {
                    Thread hilo = new Thread(planeta.AnimarSistemaSolar);
                    this.animaciones.Add(hilo);
                    hilo.Start();
                }
                this.btnSimular.Text = "Detener";
                this.Text= "Rori, Camila "+ this.Text.EstadoSimulacion(true);
            }
            else
            {
                this.LimpiarAnimaciones();
                this.btnSimular.Text = "Simular";
                this.Text = "Rori, Camila " + this.Text.EstadoSimulacion(false);
            }
        }
